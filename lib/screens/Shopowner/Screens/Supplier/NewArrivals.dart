...
class NewArrivals extends StatefulWidget {
  ...
  const NewArrivals(
      {Key key, this.supplierid, this.supplier, this.categorylist})
      : super(key: key);
  @override
...
class _NewArrivalsState extends State<NewArrivals> {
  ...
  _getItemWidget(int index) {
    print('URL IMAGE ' + newarrivals.lastadded[index].images[0].imageUrl);
    return Column(children: <Widget>[
      Stack(
        children: <Widget>[
                      ...
                      child: ClipRRect(
                        ...
                        child: Container(
                          ...
                          child: newarrivals.lastadded[index].images == null ||
                              ...
                              : CachedNetworkImage(
                                  imageUrl: newarrivals.lastadded[index]
                                              .images[0].imageUrl !=
                                          null
                                      ? newarrivals
          ...
          if (newarrivals.lastadded[index].itemDiscountPrice == null)
            Positioned(
              child: Text(
                '€ ' +
          ...
          if (newarrivals.lastadded[index].itemDiscountPrice != null)
            Positioned(
              child: Text(
                '€ ' + newarrivals.lastadded[index].itemOfflinePrice.toString(),
                style: TextStyle(
          ...
          if (newarrivals.lastadded[index].itemDiscountPrice != null)
            Positioned(
              child: Text(
                '€ ' +
                    newarrivals.lastadded[index].itemDiscountPrice.toString(),
                style: TextStyle(
                  color:
                      Theme.of(context).primaryColorDark, //Color(0xFFB7B7B7),
                  fontWeight: FontWeight.w500,
          ...
          newarrivals.lastadded[index].itemQuantity >=
                  newarrivals.lastadded[index].itemPackage
              ? Positioned(
                  child: Container(
                    height: 90,
          ...
          Positioned(
              ...
              top: 10,
              child:
                  cartProvider.checkinCart(newarrivals.lastadded[index]) == -1
                      ? Container()
                      : Container(
                          ...
                          child: Text(
                            cartProvider
                                .itmes[cartProvider
                                    .checkinCart(newarrivals.lastadded[index])]
                                .quantity
                                .toString(),
        ...
        child: Stack(
          children: <Widget>[
                  ...
                  children: <Widget>[
                              ...
                              builder: (ctx) => LanguageProvider(
                                child: ChangeNotifierProvider(
                                  child: ItemDetailsScreen(
                                    product: newarrivals.lastadded[index],
                                    supplierid: widget.supplierid,
                                    description: newarrivals.lastadded[index]
                          ...
                          child: Center(
                            child: ClipRRect(
                              ...
                              child: Container(
                                ...
                                child: newarrivals.lastadded[index].images ==
                                            null ||
                                        newarrivals
                                            .lastadded[index].images.isEmpty
                                    ? Image.asset(
                                        "assets/png/empty_cart.png",
                                        fit: BoxFit.contain,
                                        alignment: Alignment.center,
                    ...
                    RichText(
                      text: TextSpan(
                        children: [
                          TextSpan(
                              text: newarrivals.lastadded[index].id.toString() +
                                  '/' +
                                  newarrivals.lastadded[index].itemBarcode
                                      .toString(),
                              style:
                    ...
                    newarrivals.lastadded[index].itemDiscountPrice == null
                        ? Text(
                            newarrivals.lastadded[index].itemOfflinePrice
                                    .toStringAsFixed(2) +
                                ' €',
                        ...
                        : Row(
                            children: <Widget>[
                              Text(
                                newarrivals.lastadded[index].itemDiscountPrice
                                        .toString() +
                                    ' €',
                                style: TextStyle(
                                  color: Theme.of(context)
            ...
            Positioned(
                left: 10,
                top: 10,
                child: cartProvider.checkinCart(newarrivals.lastadded[index]) ==
                        -1
                    ? Container()
                    : Container(
                        padding: EdgeInsets.all(2.0),
              ...
              children: <Widget>[
                ListTile(
                  ...
                  onTap: () {
                    ...
                    itemOnTap();
                    newarrivals.lastadded.sort((a, b) => Comparable.compare(
                ...
                ListTile(
                  ...
                  onTap: () {
                    ...
                    itemOnTap();
                    newarrivals.lastadded.sort((b, a) => Comparable.compare(
                        a.product.productName.toLowerCase(),
                        b.product.productName.toLowerCase()));
                    newarrivals.notify();
                  },
          ...
          GZXDropDownMenu(
            ...
            menus: [
              GZXDropdownMenuBuilder(
                  dropDownHeight: MediaQuery.of(context).size.height * 0.50,
