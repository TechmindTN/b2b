            ...
            children: <Widget>[
              Row(
                children: <Widget>[
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            Text(
                              _orderProvide.vaildorders[index].supplier.firstName,
                              style: TextStyle(
                                  fontSize: 18.0, fontWeight: FontWeight.w700),
                            ),
                            Text(
                              "Order #1GF5D6HO${_orderProvide.vaildorders[index].id.toString()}",
                  ...
                  Expanded(
                    child: Text(
                      "\€${_orderProvide.vaildorders[index].orderPrice}",
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              _orderProvide.vaildorders[index].statut.statutName,
...
//                          collapsed: Text("loremIpsum", softWrap: true, maxLines: 2, overflow: TextOverflow.ellipsis,),
                  expanded: Column(
                    ...
                    children: <Widget>[
                      for (var i in _orderProvide.vaildorders[index].productItem)
                        Padding(
