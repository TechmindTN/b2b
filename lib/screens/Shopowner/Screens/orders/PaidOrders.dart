            ...
            children: <Widget>[
              Row(
                children: <Widget>[
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            Text(
                              _orderProvide.paidorders[index].supplier.firstName,
                              style: TextStyle(
                                  fontSize: 18.0, fontWeight: FontWeight.w700),
                            ),
                            Text(
                              "Order #1GF5D6HO${_orderProvide.paidorders[index].id.toString()}",
                  ...
                  Expanded(
                    child: Text(
                      "\€${_orderProvide.paidorders[index].orderPrice}",
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              _orderProvide.paidorders[index].statut.statutName,
