...
class _OrdersStatusState extends State<PaidOrders> {
  ...
  Widget getWidget() {
    return Consumer<CartProvider>(
      builder: (context, provider, widget) {
        ...
        else if (provider.paidorders != null &&
            provider.paidorders.isNotEmpty) {
          return ListView.builder(
            //scrollDirection: Axis.horizontal,
            shrinkWrap: true,
            controller: _scrollController,
            itemCount: provider.paidorders.length,
  ...
  Widget _getItemWidget(int index) {
    ...
    final Widget _contentCopyIconWidget = IconButton(
      ...
      onPressed: () {
        Clipboard.setData(
            ClipboardData(text: _orderProvide.paidorders[index].orderRef));
                    ...
                    children: <Widget>[
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    //flex: 5,
                                    child: Text(
                                        '${lang.tr('shopOwner.orderno')} :  ${_orderProvide.paidorders[index].orderRef}',
                      ...
                      TransactionNoTextWidget(
                        transationInfoText: _orderProvide
                                .paidorders[index].supplier.firstName +
                            ' ' +
                            _orderProvide.paidorders[index].supplier.lastName,
                        title: '${lang.tr('shopOwner.Supplier')} :',
                      ),
                      TransactionNoTextWidget(
                        transationInfoText: _orderProvide
                            .paidorders[index].statut.statutName
                            .toUpperCase(),
                  ...
                  '${Utils.getString(context, 'transaction_detail__coupon_discount')} :',
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Text(
                              '€ ${_orderProvide.paidorders[index].orderPrice.toString()}',
                              textAlign: TextAlign.left,
                              style: Theme.of(context)
                                  .textTheme
                                  .subhead
                  ...
                  header: Padding(
                      ...
                      child: Text(
                        lang.tr('shopOwner.productlist') +
                            " (" +
                            _orderProvide.paidorders[index].productItem.length
                                .toString() +
                            ')',
...
//                          collapsed: Text("loremIpsum", softWrap: true, maxLines: 2, overflow: TextOverflow.ellipsis,),
                  expanded: Column(
                    ...
                    children: <Widget>[
                      for (var i in _orderProvide.paidorders[index].productItem)
                        Padding(
