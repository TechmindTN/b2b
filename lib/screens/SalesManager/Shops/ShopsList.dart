...
class _OrdersStatusState extends State<ShopList> {
  ...
  void didChangeDependencies() {
    ...
    userProvider?.getManagerShopList(
      context,
    );
  }
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text(userProvider.user.phonenum1.toString()),
                          ],
                        ),
                      )
                    ],
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(userProvider.user.region.toString() +
                                ' ' +
                                userProvider.user.postcode.toString() +
                                ', '),
                            Text(userProvider.user.country.toString()),
                          ],
                        ),
                      )
                    ],
