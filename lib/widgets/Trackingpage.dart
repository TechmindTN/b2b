...
class _TrackingPageState extends State<TrackingPage> {
  final List<Location> locations = [
    Location('Supplier Facility', DateTime(2020, 6, 5, 5, 23, 4),
        showHour: false, isHere: true, passed: false),
    Location('Logistics Facility', DateTime(2020, 6, 6, 5, 23, 4),
  ...
  String selectedProduct = 'Point of sale';

  @override
  Widget build(BuildContext context) {
    return DecoratedBox(
       decoration:  BoxDecoration(
            image:  DecorationImage(image:  ExactAssetImage("assets/mapback.jpg"), fit: BoxFit.contain,),
          ),
      child: Container(
